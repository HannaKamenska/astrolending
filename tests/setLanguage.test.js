...
index a7adcbb7639fb11aa153f796c5bb42f6a31b7536..7fc279ea78c457b29e7df05cdc9144b862c3a94c 100644
...
+);
+
+document.getElementById('quiz-result').textContent = 'test';
+setLanguage('en');
+assert.strictEqual(
+  document.querySelector('[data-i18n="navServices"]').textContent,
+  translations.en.navServices
...
+  services[0].title.en
+);
+assert.strictEqual(document.getElementById('quiz-result').textContent, '');
+
+console.log('setLanguage updates translations and services correctly');
