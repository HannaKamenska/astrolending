...
index c4fd4f96ec4ddfdfb3daa71cb126782b0d4fb7c7..13f0f9d4833b897e01c770106bf98c4837dbcc01 100644
--- a/script.js
+++ b/script.js
@@ -1,875 +1,54 @@
- (cd "$(git rev-parse --show-toplevel)" && git apply --3way <<'EOF' 
...
+
+if (typeof module !== 'undefined') {
+  module.exports = { setLanguage, translations, services };
+}
